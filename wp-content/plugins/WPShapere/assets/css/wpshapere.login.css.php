...
$css_styles .= '}';
$css_styles .= 'form#loginform .button-primary, form#registerform .button-primary, .button-primary {
...
$css_styles .= 'form#loginform .button-primary.focus,form#loginform .button-primary.hover,
...
$css_styles .= '.login form input.input { background: #fff;
  padding: 9px 0 9px 32px !important; font-size: 16px !important; line-height: 1; outline: none !important;}
