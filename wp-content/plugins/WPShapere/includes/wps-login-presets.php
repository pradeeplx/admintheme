 ...
 */
 ...
 class WPS_LOGIN_PRESETS extends WPSHAPERE {
   ...
   function wps_login_form_wrap_close() {
     ...
     <script type="text/javascript">
       jQuery(document).ready(function(){
         jQuery( "#login h1" ).before( "<div class='wps-bg-effects'></div>" );
   ...
   {
      add_submenu_page( WPSHAPERE_MENU_SLUG , __('Login Theme Presets', 'wps'), __('Login Theme Presets', 'wps'), 'manage_options', 'wps_import_login_theme', array($this,'wps_login_presets_page') );
   }
   ...
   function wps_login_presets_page()
   {
     ...
     <div class="wrap wps-wrap">
       <?php $aof_options->licenseValidate(); ?>
         <h1><?php _e('Import Login Theme', 'wps'); ?></h1>
         ...
         <div id="wps_import_login_theme" class="clearfix">
           <form name="wps_import_login_themes" method="post" action="">
             ...
             <input type="submit"  class="button button-primary button-hero" value="<?php _e('Import Theme', 'wps'); ?>" />
