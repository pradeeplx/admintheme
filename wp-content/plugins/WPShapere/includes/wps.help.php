...
if (!class_exists('WPSHELP')) {

    class WPSHELP extends WPSHAPERE
    {
        ...
        {
            add_submenu_page( WPSHAPERE_MENU_SLUG, __('Quick Support', 'wps'), __('Need Support?', 'wps'), 'manage_options', 'wpshapere_help', array($this, 'wps_help_resources') );
        }
        ...
        function wps_help_resources() {
          ...
          <div class="clearfix wrap wps-wrap">
            <div class="wps-new-page-heading">
              <h1>WPSHAPERE <?php echo __('Help', 'wps'); ?>
                <span class="plugin_desc"><?php
                echo __('Congratulations! You have made the right choice of choosing', 'wps') . ' WPShapere. ' .
                __('You are about to use the most powerful white labelling solution for WordPress.', 'wps');
                ?></span>
              </h1>
            </div>
            ...
            <div class="wps-help-content-wrap wps-new-content-wrap">
              ...
              <h2><?php echo __('ONLINE RESOURCES', 'wps'); ?></h2>

              <div class="wps-cols-wrap">
                <div class="wps-cols wps-col-6">
                  <h2><?php echo __('Customization help', 'wps'); ?></h2>
                  <ul>
                ...
                <div class="wps-cols wps-col-6">
                  <h2><?php echo __("How to's", 'wps'); ?></h2>
                  <ul>
                ...
                <a target="_blank" href="https://kb.acmeedesign.com/kbase_categories/wpshapere/">
                  <?php echo __('View all articles', 'wps'); ?>
                </a>
                <br />
                <a class="wps-open-ticket" target="_blank" href="https://envato.acmeedesign.support">
                  <?php echo __("Can't find a solution? Open a support ticket", 'wps'); ?>
                </a>

                <div class="wps_system_details">
                  <h2><?php echo __('WordPress/Server details', 'wps'); ?></h2>
