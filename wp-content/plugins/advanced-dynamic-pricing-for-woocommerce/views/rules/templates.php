                        ...
                        <div style="display: flex;">
                            ...
                            <div class="wdp-column wdp-filter-field-type">
                                <select name="rule[{t}][{f}][type]" class="wdp-filter-type">
                                    <option value="any" selected><?php _e( 'Any product', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
                                    <option value="products"><?php _e( 'Products', 'advanced-dynamic-pricing-for-woocommerce' ); ?></option>
