...
var ssf_default_category='$ssf_default_category';
...
var contact_plc_phone='$contact_us_phone';
...
var YourSearchLocation='$YourSearchlocation';
var YourCurrentlocation='$YourCurrentlocation';
\n";
	print "//]]>\n</script>\n";
...
if($region_show!="1" && $show_all_show!="1" && $category_show!="1" && $distancePanel==false && $ssf_layout=='bottom'){	
...
function publish_ssf_request(){
	...
	$wpdb->query($wpdb->prepare("UPDATE ".SSF_WP_TABLE." SET ssf_wp_is_published=".$_GET['publish']."  WHERE ssf_wp_id IN ($id_string)"));
	die();
}
