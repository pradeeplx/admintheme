...
$ssf_wp_mdo[] = array("field_name" => "notificationlinks", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Notification Links", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='notificationlinks' value=\"$ssf_wp_vars[notificationlinks]\" class=\"my-color-field\" >");
